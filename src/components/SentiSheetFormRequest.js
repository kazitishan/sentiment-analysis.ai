// DEPRECATED (was gonna use the component as an import in the respesctive route) 
//components/SentiSheetFormRequest.js
...
//                       <th //Table header individual cell
//                         key={index}
//                         onClick={() => handleColumnSelect(index + 1)} //mapped each column with one based indexing (clicking 1st column becomes index 1 rather than 0)
